  ...
  return (
    <div className="space-y-6 text-sm text-zinc-100">
      ...
      <section className="grid gap-4 md:grid-cols-3">
        ...
        <div className="rounded-2xl border border-slate-800/80 bg-gradient-to-br from-sky-500/18 via-slate-950/85 to-slate-950/85 p-4 shadow-[0_0_32px_rgba(15,23,42,0.9)] ring-1 ring-sky-500/35 backdrop-blur-xl">
        ...
        <div className="rounded-2xl border border-slate-800/80 bg-gradient-to-br from-amber-500/18 via-slate-950/85 to-slate-950/85 p-4 shadow-[0_0_32px_rgba(15,23,42,0.9)] ring-1 ring-amber-500/35 backdrop-blur-xl">
      ...
      <section className="rounded-2xl border border-slate-800/80 bg-slate-950/80 p-4 text-xs text-zinc-400 shadow-[0_0_28px_rgba(15,23,42,0.9)] backdrop-blur-xl">
        <h3 className="text-sm font-semibold tracking-tighter text-zinc-50">
          快速操作建議
        </h3>
